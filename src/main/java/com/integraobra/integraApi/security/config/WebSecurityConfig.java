package com.integraobra.integraApi.security.config;

import com.integraobra.integraApi.security.jwt.JwtRequestFilter;
...
public class WebSecurityConfig {
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers("/api/user/**", "/api/auth/**", "/api/document/**").permitAll()
    ...
    CorsConfigurationSource corsConfigurationSource() {
        return request -> {
            ...
            cors.setAllowedMethods(java.util.List.of("GET", "POST", "PUT", "DELETE", "OPTIONS", "PATCH")); // Permitir métodos HTTP comunes
